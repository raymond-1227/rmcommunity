...
4. **Spam** - Do not spam messages in channels, nor acting stupid (e.g. **_YELLING_** in voice channels)
...
8. **Bot Abuse** - Unless it fits within the conversation of the channel, use bot commands in the #bot-spam channel.
